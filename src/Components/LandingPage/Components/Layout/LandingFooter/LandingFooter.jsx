        ...
        <div className={styles.footerGrid}>
          <div className={styles.brandCol}>
            ...
            <p className={styles.brandDesc}>
              النظام الأذكى والأسرع لإدارة مزارع الدواجن وتحليل بياناتها بدقة
              عالية للحصول على أعلى إنتاجية وأقل نسبة هدر.
            </p>
          </div>
      ...
      <div className={styles.footerBottom}>
        <div className={styles.bottomContent}>
          <div className={styles.bottomSection}>
            <p>
              &copy; {new Date().getFullYear()} Dawagen. جميع الحقوق محفوظة.
            </p>
          </div>

          <div className={styles.developerSection}>
            <span className={styles.devCredit}>
              <span className={styles.devName}>Raafat Shahin</span> Developed by
            </span>
            <div className={styles.socialLinks}>
              <a
                href="https://github.com/RaafatReda1"
                target="_blank"
                rel="noreferrer"
