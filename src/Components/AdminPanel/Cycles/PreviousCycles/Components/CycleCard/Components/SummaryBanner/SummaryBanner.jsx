...
const SummaryBanner = ({ totalRevenue, totalExpenses, netProfitLoss }) => {
  ...
  const formattedNet = `${isProfit ? "+" : ""}${netProfitLoss.toLocaleString()} EGP`;
  ...
  return (
    <div className={styles.banner}>
      ...
      <div className={styles.statBox}>
        ...
        <span className={styles.statValue}>{totalRevenue.toLocaleString()} EGP</span>
      </div>
      <div className={styles.statBox}>
        ...
        <span className={styles.statValue}>{totalExpenses.toLocaleString()} EGP</span>
      </div>
    </div>
  );
};
